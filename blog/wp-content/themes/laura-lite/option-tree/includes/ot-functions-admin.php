          ...
          array(
            ...
            'pages'               => array( 
              array(
                ...
                'page_title'      => apply_filters( 'ot_theme_options_page_title', __( 'Theme Options', 'laura' ) ),
                'menu_title'      => apply_filters( 'ot_theme_options_menu_title', __( 'Theme Options', 'laura' ) ),
                ...
                'updated_message' => apply_filters( 'ot_theme_options_updated_message', __( 'Theme Options updated.', 'laura' ) ),
                'reset_message'   => apply_filters( 'ot_theme_options_reset_message', __( 'Theme Options reset.', 'laura' ) ),
                'button_text'     => apply_filters( 'ot_theme_options_button_text', __( 'Save Changes', 'laura' ) ),
  ...
  function ot_register_settings_page() {
    ...
    if ( OT_SHOW_OPTIONS_UI == true && isset( $_REQUEST['page'] ) && $_REQUEST['page'] == 'ot-settings' && ( $ot_has_custom_theme_options == true || has_action( 'admin_init', 'custom_theme_options' ) || has_action( 'init', 'custom_theme_options' ) ) ) {
      ...
      function ot_has_custom_theme_options() {
        ...
        echo '<div class="error"><p>' . __( 'The Theme Options UI Builder is being overridden by a custom file in your theme. Any changes you make via the UI Builder will not be saved.', 'laura' ) . '</p></div>';
    ...
    $ot_register_pages_array =  array( 
      array( 
        'id'              => 'ot',
        'page_title'      => __( 'OptionTree', 'laura' ),
        'menu_title'      => __( 'OptionTree', 'laura' ),
      ...
      array(
        ...
        'page_title'      => __( 'Settings', 'laura' ),
        'menu_title'      => __( 'Settings', 'laura' ),
        'capability'      => 'edit_theme_options',
        'menu_slug'       => 'ot-settings',
        'icon_url'        => null,
        'position'        => null,
        'updated_message' => __( 'Theme Options updated.', 'laura' ),
        'reset_message'   => __( 'Theme Options reset.', 'laura' ),
        'button_text'     => __( 'Save Settings', 'laura' ),
        'show_buttons'    => false,
        'sections'        => array(
          array(
            'id'          => 'create_setting',
            'title'       => __( 'Theme Options UI', 'laura' )
          ),
          array(
            'id'          => 'import',
            'title'       => __( 'Import', 'laura' )
          ),
          array(
            'id'          => 'export',
            'title'       => __( 'Export', 'laura' )
          ),
          array(
            'id'          => 'layouts',
            'title'       => __( 'Layouts', 'laura' )
          )
        ),
        'settings'        => array(
          array(
            'id'          => 'theme_options_ui_text',
            'label'       => __( 'Theme Options UI Builder', 'laura' ),
            'type'        => 'theme_options_ui',
            'section'     => 'create_setting'
          ),
          array(
            'id'          => 'import_xml_text',
            'label'       => __( 'Settings XML', 'laura' ),
            'type'        => 'import-xml',
            'section'     => 'import'
          ),
          array(
            'id'          => 'import_settings_text',
            'label'       => __( 'Settings', 'laura' ),
            'type'        => 'import-settings',
            'section'     => 'import'
          ),
          array(
            'id'          => 'import_data_text',
            'label'       => __( 'Theme Options', 'laura' ),
            'type'        => 'import-data',
            'section'     => 'import'
          ),
          array(
            'id'          => 'import_layouts_text',
            'label'       => __( 'Layouts', 'laura' ),
            'type'        => 'import-layouts',
            'section'     => 'import'
          ),
          array(
            'id'          => 'export_settings_file_text',
            'label'       => __( 'Settings PHP File', 'laura' ),
          ...
          array(
            ...
            'label'       => __( 'Layout Management', 'laura' ),
            'type'        => 'modify-layouts',
            'section'     => 'layouts'
          )
        )
      ...
      array(
        'id'              => 'documentation',
        'parent_slug'     => 'ot-settings',
        'page_title'      => __( 'Documentation', 'laura' ),
        'menu_title'      => __( 'Documentation', 'laura' ),
        'capability'      => 'edit_theme_options',
        ...
        'sections'        => array(
          array(
            'id'          => 'creating_options',
            'title'       => __( 'Creating Options', 'laura' )
          ),
          array(
            'id'          => 'option_types',
            'title'       => __( 'Option Types', 'laura' )
          ),
          array(
            'id'          => 'functions',
            'title'       => __( 'Function References', 'laura' )
          ),
          array(
            'id'          => 'theme_mode',
            'title'       => __( 'Theme Mode', 'laura' )
          ),
          array(
            'id'          => 'meta_boxes',
            'title'       => __( 'Meta Boxes', 'laura' )
          ),
          array(
            'id'          => 'examples',
            'title'       => __( 'Code Examples', 'laura' )
          ),
          array(
            'id'          => 'layouts_overview',
            'title'       => __( 'Layouts Overview', 'laura' )
          )
        ),
        'settings'        => array(
          array(
            'id'          => 'creating_options_text',
            'label'       => __( 'Overview of available Theme Option fields.', 'laura' ),
            'type'        => 'creating-options',
            'section'     => 'creating_options'
          ),
          array(
            'id'          => 'option_types_text',
            'label'       => __( 'Option types in alphabetical order & hooks to filter them.', 'laura' ),
            'type'        => 'option-types',
            'section'     => 'option_types'
          ),
          array(
            'id'          => 'functions_ot_get_option',
            'label'       => __( 'Function Reference:ot_get_option()', 'laura' ),
            'type'        => 'ot-get-option',
            'section'     => 'functions'
          ),
          array(
            'id'          => 'functions_get_option_tree',
            'label'       => __( 'Function Reference:get_option_tree()', 'laura' ),
            'type'        => 'get-option-tree',
            'section'     => 'functions'
          ),
          array(
            'id'          => 'theme_mode_text',
            'label'       => __( 'Theme Mode', 'laura' ),
            'type'        => 'theme-mode',
            'section'     => 'theme_mode'
          ),
          array(
            'id'          => 'meta_boxes_text',
            'label'       => __( 'Meta Boxes', 'laura' ),
            'type'        => 'meta-boxes',
            'section'     => 'meta_boxes'
          ),
          array(
            'id'          => 'example_text',
            'label'       => __( 'Code examples for front-end development.', 'laura' ),
            'type'        => 'examples',
            'section'     => 'examples'
          ),
          array(
            'id'          => 'layouts_overview_text',
            'label'       => __( 'What\'s a layout anyhow?', 'laura' ),
    ...
    if ( 'background' == $type ) {
      ...
      foreach( $input as $key => $value ) {
        ...
        if ( $key == 'width' && ! empty( $value ) && ! is_numeric( $value ) ) {
          ...
          add_settings_error( 'laura', 'invalid_border_width', sprintf( __( 'The %s input field for %s only allows numeric values.', 'laura' ), '<code>width</code>', '<code>' . $field_id . '</code>' ), 'error' );
      ...
      if ( 0 === preg_match( '/^#([a-f0-9]{6}|[a-f0-9]{3})$/i', $input ) && 0 === preg_match( '/^rgba\(\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9\.]{1,4})\s*\)/i', $input ) ) {
        ...
        add_settings_error( 'laura', 'invalid_hex', sprintf( __( 'The %s Colorpicker only allows valid hexadecimal or rgba values.', 'laura' ), '<code>' . $field_id . '</code>' ), 'error' );
      ...
      if ( isset( $errors ) ) {
        ...
        foreach( $errors as $error ) {
          ...
          add_settings_error( 'laura', 'invalid_dimension_' . $error, sprintf( __( 'The %s input field for %s only allows numeric values.', 'laura' ), '<code>' . $error . '</code>', '<code>' . $field_id . '</code>' ), 'error' );
...
//      unset($input['%key%']);
      ...
      if ( isset( $errors ) ) {
        ...
        foreach( $errors as $error ) {
          ...
          add_settings_error( 'laura', 'invalid_spacing_' . $error, sprintf( __( 'The %s input field for %s only allows numeric values.', 'laura' ), '<code>' . $error . '</code>', '<code>' . $field_id . '</code>' ), 'error' );
...
if ( ! function_exists( 'ot_admin_scripts' ) ) {
  ...
  function ot_admin_scripts() {
    ...
    $localized_array = array( 
      ...
      'upload_text'           => apply_filters( 'ot_upload_text', __( 'Send to OptionTree', 'laura' ) ),
      'remove_media_text'     => __( 'Remove Media', 'laura' ),
      'reset_agree'           => __( 'Are you sure you want to reset back to the defaults?', 'laura' ),
      'remove_no'             => __( 'You can\'t remove this! But you can edit the values.', 'laura' ),
      'remove_agree'          => __( 'Are you sure you want to remove this?', 'laura' ),
      'activate_layout_agree' => __( 'Are you sure you want to activate this layout?', 'laura' ),
      'setting_limit'         => __( 'Sorry, you can\'t have settings three levels deep.', 'laura' ),
      'delete'                => __( 'Delete Gallery', 'laura' ), 
      'edit'                  => __( 'Edit Gallery', 'laura' ), 
      'create'                => __( 'Create Gallery', 'laura' ), 
      'confirm'               => __( 'Are you sure you want to delete this Gallery?', 'laura' ),
      'date_current'          => __( 'Today', 'laura' ),
      'date_time_current'     => __( 'Now', 'laura' ),
      'date_close'            => __( 'Close', 'laura' ),
      'replace'               => __( 'Featured Image', 'laura' ),
      'with'                  => __( 'Image', 'laura' )
    );
...
if ( ! function_exists( 'ot_get_media_post_ID' ) ) {
  ...
  function ot_get_media_post_ID() {
    ...
    if ( $post_ID === false || empty( $post_ID ) ) {
      ...
      // Get the media post ID
      $post_ID = $wpdb->get_var( "SELECT ID FROM $wpdb->posts WHERE `post_title` = 'Media' AND `post_type` = 'laura' AND `post_status` = 'private'" );
...
if ( ! function_exists( 'ot_create_media_post' ) ) {
  ...
  function ot_create_media_post() {
    ...
    $regsiter_post_type( 'laura', array(
      'labels'              => array( 'name' => __( 'Option Tree', 'laura' ) ),
      'public'              => false,
      'show_ui'             => false,
      ...
      if ( ! isset( $settings['sections'] ) || ! isset( $settings['settings'] ) ) {
        ...
        $settings = array(
          'sections' => array(
            array(
              'id'        => 'general',
              'title'     => __( 'General', 'laura' )
            )
          ),
          'settings' => array(
            array(
              'id'        => 'sample_text',
              'label'     => __( 'Sample Text Field Label', 'laura' ),
              'desc'      => __( 'Description for the sample text field.', 'laura' ),
              'section'   => 'general',
              'type'      => 'text',
              'std'       => '',
              'class'     => '',
  ...
  function ot_export_php_settings_array() {
    ...
    if ( isset( $option_tree_settings['sections'] ) ) {
      foreach( $option_tree_settings['sections'] as $value ) {
        $_id = isset( $value['id'] ) ? $value['id'] : '';
        $_title = ot_I18n_string( isset( $value['title'] ) ? str_replace( "'", "\'", $value['title'] ) : '' );
		$_font = ot_I18n_string( isset( $value['font'] ) ? str_replace( "'", "\'", $value['font'] ) : '' );
        $sections.= "
      array(
		'font'        => $_font,
        'id'          => '$_id',
  ...
  function ot_alert_message( $page = array() ) {
    ...
    if ( $action == 'save-settings' ) {
      ...
      if ( $message == 'success' ) {
        ...
        return '<div id="message" class="updated fade below-h2"><p>' . __( 'Settings updated.', 'laura' ) . '</p></div>';
        
      } else if ( $message == 'failed' ) {
        
        return '<div id="message" class="error fade below-h2"><p>' . __( 'Settings could not be saved.', 'laura' ) . '</p></div>';
      ...
      if ( $message == 'success' ) {
        ...
        return '<div id="message" class="updated fade below-h2"><p>' . __( 'Settings Imported.', 'laura' ) . '</p></div>';
        
      } else if ( $message == 'failed' ) {
        
        return '<div id="message" class="error fade below-h2"><p>' . __( 'Settings could not be imported.', 'laura' ) . '</p></div>';
      ...
      if ( $message == 'success' ) {
        ...
        return '<div id="message" class="updated fade below-h2"><p>' . __( 'Data Imported.', 'laura' ) . '</p></div>';
        
      } else if ( $message == 'failed' ) {
        
        return '<div id="message" class="error fade below-h2"><p>' . __( 'Data could not be imported.', 'laura' ) . '</p></div>';
      ...
      if ( $message == 'success' ) {
        ...
        return '<div id="message" class="updated fade below-h2"><p>' . __( 'Layouts Imported.', 'laura' ) . '</p></div>';
        
      } else if ( $message == 'failed' ) {
        
        return '<div id="message" class="error fade below-h2"><p>' . __( 'Layouts could not be imported.', 'laura' ) . '</p></div>';
      ...
      if ( $message == 'success' ) {
        ...
        return '<div id="message" class="updated fade below-h2"><p>' . __( 'Layouts Updated.', 'laura' ) . '</p></div>';
        
      } else if ( $message == 'failed' ) {
        
        return '<div id="message" class="error fade below-h2"><p>' . __( 'Layouts could not be updated.', 'laura' ) . '</p></div>';
        
      } else if ( $message == 'deleted' ) {
        
        return '<div id="message" class="updated fade below-h2"><p>' . __( 'Layouts have been deleted.', 'laura' ) . '</p></div>';
        
      }
    
    } else if ( $updated == 'layout' ) {  
       
      return '<div id="message" class="updated fade below-h2"><p>' . __( 'Layout activated.', 'laura' ) . '</p></div>';
...
if ( ! function_exists( 'ot_option_types_array' ) ) {
  ...
  function ot_option_types_array() {
    ...
    return apply_filters( 'ot_option_types_array', array( 
      'background'                => esc_html__('Background', 'laura'),
      'border'                    => esc_html__('Border', 'laura'),
      'box-shadow'                => esc_html__('Box Shadow', 'laura'),
      'category-checkbox'         => esc_html__('Category Checkbox', 'laura'),
      'category-select'           => esc_html__('Category Select', 'laura'),
      'checkbox'                  => esc_html__('Checkbox', 'laura'),
      'colorpicker'               => esc_html__('Colorpicker', 'laura'),
      'colorpicker-opacity'       => esc_html__('Colorpicker Opacity', 'laura'),
      'css'                       => esc_html__('CSS', 'laura'),
      'custom-post-type-checkbox' => esc_html__('Custom Post Type Checkbox', 'laura'),
      'custom-post-type-select'   => esc_html__('Custom Post Type Select', 'laura'),
      'date-picker'               => esc_html__('Date Picker', 'laura'),
      'date-time-picker'          => esc_html__('Date Time Picker', 'laura'),
      'dimension'                 => esc_html__('Dimension', 'laura'),
      'gallery'                   => esc_html__('Gallery', 'laura'),
      'google-fonts'              => esc_html__('Google Fonts', 'laura'),
      'heading'                   => esc_html__('Heading', 'laura'),	 
	  'import'                   => esc_html__('Import', 'laura'),	  	  
      'javascript'                => esc_html__('JavaScript', 'laura'),
      'link-color'                => esc_html__('Link Color', 'laura'),
      'list-item'                 => esc_html__('List Item', 'laura'),
      'measurement'               => esc_html__('Measurement', 'laura'),
      'numeric-slider'            => esc_html__('Numeric Slider', 'laura'),
      'on-off'                    => esc_html__('On/Off', 'laura'),
      'page-checkbox'             => esc_html__('Page Checkbox', 'laura'),
      'page-select'               => esc_html__('Page Select', 'laura'),
      'post-checkbox'             => esc_html__('Post Checkbox', 'laura'),
      'post-select'               => esc_html__('Post Select', 'laura'),
      'radio'                     => esc_html__('Radio', 'laura'),
      'radio-image'               => esc_html__('Radio Image', 'laura'),
      'select'                    => esc_html__('Select', 'laura'),
      'sidebar-select'            => esc_html__('Sidebar Select',  'laura'),
      'slider'                    => esc_html__('Slider', 'laura'),
      'social-links'              => esc_html__('Social Links', 'laura'),
      'spacing'                   => esc_html__('Spacing', 'laura'),
      'tab'                       => esc_html__('Tab', 'laura'),
      'tag-checkbox'              => esc_html__('Tag Checkbox', 'laura'),
      'tag-select'                => esc_html__('Tag Select', 'laura'),
      'taxonomy-checkbox'         => esc_html__('Taxonomy Checkbox', 'laura'),
      'taxonomy-select'           => esc_html__('Taxonomy Select', 'laura'),
      'text'                      => esc_html__('Text', 'laura'),
      'textarea'                  => esc_html__('Textarea', 'laura'),
      'textarea-simple'           => esc_html__('Textarea Simple', 'laura'),
      'textblock'                 => esc_html__('Textblock', 'laura'),
      'textblock-titled'          => esc_html__('Textblock Titled', 'laura'),
	  'typography_f_s'                => esc_html__('Typography face/style', 'laura'),
	  'typography_c_s'                => esc_html__('Typography color/size', 'laura'),	  
      'typography'                => esc_html__('Typography', 'laura'),
      'upload'                    => esc_html__('Upload', 'laura')
    ) );
...
if ( ! function_exists( 'ot_radio_images' ) ) {
  ...
  function ot_radio_images( $field_id = '' ) {
    ...
    return apply_filters( 'ot_radio_images', array(
      array(
        'value'   => 'left-sidebar',
        'label'   => __( 'Left Sidebar', 'laura' ),
        'src'     => OT_URL . 'assets/images/layout/left-sidebar.png'
      ),
      array(
        'value'   => 'right-sidebar',
        'label'   => __( 'Right Sidebar', 'laura' ),
        'src'     => OT_URL . 'assets/images/layout/right-sidebar.png'
      ),
      array(
        'value'   => 'full-width',
        'label'   => __( 'Full Width (no sidebar)', 'laura' ),
  ...
  function ot_social_links_settings( $id ) {
    ...
    $settings = apply_filters( 'ot_social_links_settings', array(
      array(
        'id'        => 'name',
        'label'     => __( 'Name', 'laura' ),
        'desc'      => __( 'Enter the name of the social website.', 'laura' ),
        'std'       => '',
        'type'      => 'text',
      ...
      array(
        'id'        => 'title',
        'label'     => 'Title',
        'desc'      => __( 'Enter the text shown in the title attribute of the link.', 'laura' ),
        'type'      => 'text'
      ),
      array(
        'id'        => 'href',
        'label'     => 'Link',
        'desc'      => sprintf( __( 'Enter a link to the profile or page on the social website. Remember to add the %s part to the front of the link.', 'laura' ), '<code>http://</code>' ),
        'type'      => 'text',
      )
    ), $id );
  ...
  function ot_insert_css_with_markers( $field_id = '', $insertion = '', $meta = false ) {
    ...
    if ( file_exists( $filepath ) ) {
      ...
      foreach( $matches[0] as $option ) {
        ...
        if ( is_array( $value ) ) {
          ...
          if ( empty( $option_key ) ) {
			...
			// typography_f_c
            } else if ( $option_type == 'typography_f_c' ) {
              $font = array();
      ...
      if ( ! is_writable( $filepath ) ) {
        add_settings_error( 'laura', 'dynamic_css', sprintf( __( 'Unable to write to file %s.', 'laura' ), '<code>' . $filepath . '</code>' ), 'error' );
        return false;
      }
  ...
  function ot_sections_view( $name, $key, $section = array() ) {
    ...
    <div class="option-tree-setting is-section">
      ...
      <div class="button-section">
        <a href="javascript:void(0);" class="option-tree-setting-edit option-tree-ui-button button left-item" title="' . __( 'edit', 'laura' ) . '">
          <span class="icon ot-icon-pencil"></span>' . __( 'Edit', 'laura' ) . '
        </a>
        <a href="javascript:void(0);" class="option-tree-setting-remove option-tree-ui-button button button-secondary light right-item" title="' . __( 'Delete', 'laura' ) . '">
          <span class="icon ot-icon-trash-o"></span>' . __( 'Delete', 'laura' ) . '
        </a>
      </div>
      <div class="option-tree-setting-body">
        <div class="format-settings">
          <div class="format-setting type-text">
            <div class="description">' . __( '<strong>Font icon</strong>: Add font icon before title.', 'laura' ) . '</div>
            <div class="format-setting-inner">
              <input type="text" name="' . esc_attr( $name ) . '[' . esc_attr( $key ) . '][font]" value="' . ( isset( $section['font'] ) ? esc_attr( $section['font'] ) : '' ) . '" class="widefat option-tree-ui-input option-tree-setting-font section-font" autocomplete="off" />
            </div>
          </div>
        </div>	  
        <div class="format-settings">
          <div class="format-setting type-text">
            <div class="description">' . __( '<strong>Section Title</strong>: Displayed as a menu item on the Theme Options page.', 'laura' ) . '</div>
            <div class="format-setting-inner">
        ...
        <div class="format-settings">
          <div class="format-setting type-text">
            <div class="description">' . __( '<strong>Section ID</strong>: A unique lower case alphanumeric string, underscores allowed.', 'laura' ) . '</div>
            <div class="format-setting-inner">
      ...
      <div class="option-tree-setting-body">
        <div class="format-settings">
          <div class="format-setting type-text wide-desc">
            <div class="description">' . __( '<strong>Label</strong>: Displayed as the label of a form element on the Theme Options page.', 'laura' ) . '</div>
            <div class="format-setting-inner">
        ...
        <div class="format-settings">
          <div class="format-setting type-text wide-desc">
            <div class="description">' . __( '<strong>ID</strong>: A unique lower case alphanumeric string, underscores allowed.', 'laura' ) . '</div>
            <div class="format-setting-inner">
        ...
        <div class="format-settings">
          <div class="format-setting type-select wide-desc">
            <div class="description">' . __( '<strong>Type</strong>: Choose one of the available option types from the dropdown.', 'laura' ) . '</div>
            <div class="format-setting-inner">
        ...
        <div class="format-settings">
          <div class="format-setting type-textarea wide-desc">
            <div class="description">' . __( '<strong>Description</strong>: Enter a detailed description for the users to read on the Theme Options page, HTML is allowed. This is also where you enter content for both the Textblock & Textblock Titled option types.', 'laura' ) . '</div>
            <div class="format-setting-inner">
        ...
        <div class="format-settings">
          <div class="format-setting type-textblock wide-desc">
            <div class="description">' . __( '<strong>Choices</strong>: This will only affect the following option types: Checkbox, Radio, Select & Select Image.', 'laura' ) . '</div>
            <div class="format-setting-inner">
              ...
              <a href="javascript:void(0);" class="option-tree-choice-add option-tree-ui-button button hug-left">' . __( 'Add Choice', 'laura' ) . '</a>
            </div>
          </div>
        </div>
        <div class="format-settings">
          <div class="format-setting type-textblock wide-desc">
            <div class="description">' . __( '<strong>Settings</strong>: This will only affect the List Item option type.', 'laura' ) . '</div>
            <div class="format-setting-inner">
              <ul class="option-tree-setting-wrap option-tree-sortable" data-name="' . esc_attr( $name ) . '[' . esc_attr( $key ) . ']">
                ' . ( isset( $setting['settings'] ) ? ot_loop_through_sub_settings( $name . '[' . $key . '][settings]', $setting['settings'] ) : '' ) . '
              </ul>
              <a href="javascript:void(0);" class="option-tree-list-item-setting-add option-tree-ui-button button hug-left">' . __( 'Add Setting', 'laura' ) . '</a>
            </div>
          </div>
        </div>
        <div class="format-settings">
          <div class="format-setting type-text wide-desc">
            <div class="description">' . __( '<strong>Standard</strong>: Setting the standard value for your option only works for some option types. Read the <code>OptionTree->Documentation</code> for more information on which ones.', 'laura' ) . '</div>
            <div class="format-setting-inner">
              ' . $std_form_element . '
            </div>
          </div>
        ...
        <div class="format-settings">
          <div class="format-setting type-text wide-desc">
            <div class="description">' . __( '<strong>Rows</strong>: Enter a numeric value for the number of rows in your textarea. This will only affect the following option types: CSS, Textarea, & Textarea Simple.', 'laura' ) . '</div>
            <div class="format-setting-inner">
        ...
        <div class="format-settings">
          <div class="format-setting type-text wide-desc">
            <div class="description">' . __( '<strong>Post Type</strong>: Add a comma separated list of post type like \'post,page\'. This will only affect the following option types: Custom Post Type Checkbox, & Custom Post Type Select.', 'laura' ) . '</div>
            <div class="format-setting-inner">
        ...
        <div class="format-settings">
          <div class="format-setting type-text wide-desc">
            <div class="description">' . __( '<strong>Taxonomy</strong>: Add a comma separated list of any registered taxonomy like \'category,post_tag\'. This will only affect the following option types: Taxonomy Checkbox, & Taxonomy Select.', 'laura' ) . '</div>
            <div class="format-setting-inner">
        ...
        <div class="format-settings">
          <div class="format-setting type-text wide-desc">
            <div class="description">' . __( '<strong>Min, Max, & Step</strong>: Add a comma separated list of options in the following format <code>0,100,1</code> (slide from <code>0-100</code> in intervals of <code>1</code>). The three values represent the minimum, maximum, and step options and will only affect the Numeric Slider option type.', 'laura' ) . '</div>
            <div class="format-setting-inner">
        ...
        <div class="format-settings">
          <div class="format-setting type-text wide-desc">
            <div class="description">' . __( '<strong>CSS Class</strong>: Add and optional class to this option type.', 'laura' ) . '</div>
            <div class="format-setting-inner">
        ...
        <div class="format-settings">
          <div class="format-setting type-select wide-desc">
            <div class="description">' . __( '<strong>Operator</strong>: Choose the logical operator to compute the result of the conditions.', 'laura' ) . '</div>
            <div class="format-setting-inner">
              <select name="' . esc_attr( $name ) . '[' . esc_attr( $key ) . '][operator]" value="' . $operator . '" class="option-tree-ui-select">
                <option value="and" ' . selected( $operator, 'and', false ) . '>' . __( 'and', 'laura' ) . '</option>
                <option value="or" ' . selected( $operator, 'or', false ) . '>' . __( 'or', 'laura' ) . '</option>
              </select>
            </div>
          </div>
        </div>
  ...
  function ot_choices_view( $name, $key, $choice = array() ) {
    ...
    <div class="option-tree-setting">
      ...
      <div class="option-tree-setting-body">
        ...
        <div class="format-settings">
          <div class="format-setting-label">
            <h5>' . __( 'Image Source (Radio Image only)', 'laura' ) . '</h5>
          </div>
          <div class="format-setting type-text wide-desc">
            <div class="format-setting-inner">
      ...
      <div class="option-tree-setting-body">
        <div class="format-settings">
          <div class="format-setting type-text no-desc">
            <div class="description">' . __( '<strong>Title</strong>: Displayed as a contextual help menu item on the Theme Options page.', 'laura' ) . '</div>
            <div class="format-setting-inner">
        ...
        <div class="format-settings">
          <div class="format-setting type-textarea no-desc">
            <div class="description">' . __( '<strong>Content</strong>: Enter the HTML content about this contextual help item displayed on the Theme Option page for end users to read.', 'laura' ) . '</div>
            <div class="format-setting-inner">
...
if ( ! function_exists( 'ot_layout_view' ) ) {
  ...
  function ot_layout_view( $key, $data = '', $active_layout = '' ) {
    ...
    return '
    <div class="option-tree-setting">
      <div class="open">' . ( isset( $key ) ? esc_attr( $key ) : __( 'Layout', 'laura' ) ) . '</div>
      <div class="button-section">
        <a href="javascript:void(0);" class="option-tree-layout-activate option-tree-ui-button button left-item' . ( $active_layout == $key ? ' active' : '' ) . '" title="' . __( 'Activate', 'laura' ) . '">
          <span class="icon ot-icon-square-o"></span>' . __( 'Activate', 'laura' ) . '
        </a>
        <a href="javascript:void(0);" class="option-tree-setting-remove option-tree-ui-button button button-secondary light right-item" title="'. __( 'Delete', 'laura' ) . '">
          <span class="icon ot-icon-trash-o"></span>' . __( 'Delete', 'laura' ) . '
        </a>
  ...
  function ot_list_item_view( $name, $key, $list_item = array(), $post_id = 0, $get_option = '', $settings = array(), $type = '' ) {
    ...
    <div class="option-tree-setting">
      ...
      foreach( $settings as $field ) {
        ...
        /* option label */
		if ( $_args['type'] == 'heading') { $heading = 'heading';} else {$heading = '';} 
        echo '<div id="setting_' . $_args['field_id'] . '" class="' . $class . '"' . $conditions . ' '.$heading.'>';
  ...
  function ot_social_links_view( $name, $key, $list_item = array(), $post_id = 0, $get_option = '', $settings = array(), $type = '' ) {
    ...
    <div class="option-tree-setting">
      ...
      foreach( $settings as $field ) {
        ...
        /* option label */
		if ( $_args['type'] == 'heading') { $heading = 'heading';} else {$heading = '';} 
        echo '<div id="setting_' . $_args['field_id'] . '" class="format-settings"' . $conditions . ' '. $heading .'>';
  ...
  function ot_theme_options_layouts_form( $active = false ) {
    ...
    echo '<form method="post" id="option-tree-options-layouts-form">';
      ...
      echo '<div class="option-tree-save-layout' . ( ! empty( $active_layout ) ? ' active-layout' : '' ) . '">';
        ...
        echo '<button type="submit" class="option-tree-ui-button button button-primary save-layout" title="' . __( 'New Layout', 'laura' ) . '">' . __( 'New Layout', 'laura' ) . '</button>';
...
function ot_fetch_google_fonts( $normalize = true, $force_rebuild = false ) {
  ...
  if ( $force_rebuild || ! is_array( $ot_google_fonts ) || empty( $ot_google_fonts ) ) {
    ...
    $ot_google_fonts_api_key = apply_filters( 'ot_google_fonts_api_key', 'AIzaSyD6yJz1R2CEHI1dnreOrLLa4QElRpDqarU' );
  ...
  return apply_filters( 'ot_meta_box_post_format_quote', array(
    ...
    'fields'    => array(
      array(
        ...
        'label'   => '',
        'desc'    => __( 'Source Name (ex. author, singer, actor)', 'laura' ),
        'std'     => '',
        'type'    => 'text'
      ),
      array(
      ...
      array(
        ...
        'label'   => '',
        'desc'    => __( 'Source Title (ex. book, song, movie)', 'laura' ),
        'std'     => '',
        'type'    => 'text'
      ),
      array(
  ...
  return apply_filters( 'ot_meta_box_post_format_video', array(
    ...
    'fields'    => array(
      array(
        ...
        'label'   => '',
        'desc'    => sprintf( __( 'Embed video from services like Youtube, Vimeo, or Hulu. You can find a list of supported oEmbed sites in the %1$s. Alternatively, you could use the built-in %2$s shortcode.', 'laura' ), '<a href="http://codex.wordpress.org/Embeds" target="_blank">' . __( 'WordPress Codex', 'laura' ) .'</a>', '<code>[video]</code>' ),
        'std'     => '',
        'type'    => 'textarea'
      )
  	)
  ...
  return apply_filters( 'ot_meta_box_post_format_audio', array(
    ...
    'fields'    => array(
      array(
        ...
        'label'   => '',
        'desc'    => sprintf( __( 'Embed audio from services like SoundCloud and Rdio. You can find a list of supported oEmbed sites in the %1$s. Alternatively, you could use the built-in %2$s shortcode.', 'laura' ), '<a href="http://codex.wordpress.org/Embeds" target="_blank">' . __( 'WordPress Codex', 'laura' ) .'</a>', '<code>[audio]</code>' ),
        'std'     => '',
        'type'    => 'textarea'
      )
  	)
