...
<div id="comments">
    ...
    <script>
        jQuery(document).ready(function($) {
            ...
            $('.temp_submit_comment').html('<div class=\"send_this_comment shortcode_button btn_small btn_type5\"><span class=\"ico_cont\"><span class=\"ico_fader\"></span><i class=\"ico_this icon-share-alt\"></i></span><span class=\"btn_text\">" . __('ENVIAR', 'theme_localization') . "</span></div>');
    ...
    if (have_comments()) : ?>
        <h6 class="headInModule postcomment"><?php echo __('COMENTÁRIOS', 'theme_localization') . ": ";
    ...
    <?php if ('open' == $post->comment_status) :
        ...
        $comment_form = array(
            'fields' => apply_filters('comment_form_default_fields', array(
                'author' => '<label class="label-name"></label><input type="text" placeholder="' . __('Nome *', 'theme_localization') . '" title="' . __('Name *', 'theme_localization') . '" id="author" name="author" class="form_field">',
            ...
            'comment_field' => '<label class="label-message"></label><textarea name="comment" cols="45" rows="5" placeholder="' . __('Comentário...', 'theme_localization') . '" id="comment-message" class="form_field"></textarea>',
            'comment_form_before' => '',
            'comment_form_after' => '',
            'must_log_in' => __('Você precisa estar loggado para deixar um comentário', 'theme_localization'),
            'title_reply' => __('Deixe um comentário!', 'theme_localization'),
            'label_submit' => __('Enviar', 'theme_localization'),
