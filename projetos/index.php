...
<div class="container o-content">
	...
	<div class="row o-job-list">
		<div class="col">
			<a href="d-va.php" class="filterDiv ilustracao">
			...
			<a href="oceana.php" class="filterDiv web">
			...
			<a href="dn-assessoria.php" class="filterDiv identidade">
			...
			<a href="boom-inteligencia-digital.php" class="filterDiv identidade">
			...
			<a href="junta-7.php" class="filterDiv identidade">
			...
			<a href="projeto-luz-e-amor.php" class="filterDiv identidade">
			...
			<a href="scaffold-platform.php" class="filterDiv web">
				<img src="../images/scaffold-thumbnail.jpg">
				<p>
					<span>Web</span><br />
					Oceana
				</p>
			</a>
			<a href="inquisitora.php" class="filterDiv ilustracao">
			...
			<a href="ilustracao-tatuagem.php" class="filterDiv ilustracao">
			...
			<a href="womansplaining.php" class="filterDiv identidade web">
				<img src="https://olacarol.com.br/blog/wp-content/uploads/2015/06/womansplaining1-1170x1170.jpg">
				<p>
					<span>Identidade visual & Web</span><br />
					Womansplaining
				</p>
			</a>
			<a href="diagramacao.php" class="filterDiv design">
				...
				<p>
					...
					Diagramação Caderno Gastronômico
				</p>
			</a>
			<a href="plena-voz.php" class="filterDiv identidade">
			...
			<a href="aonde-nao-ir.php" class="filterDiv identidade">
			...
			<a href="projeto-tcc.php" class="filterDiv identidade">
			...
			<a href="cartaz-premio-excelencia-grafica.php" class="filterDiv identidade">
